...
/*
+==========================================================================+
|  $Header: /source/iam/oracle/custom/package\040body/XX_APPL_COMMON_PKG_1.sql,v 1.1 2014/12/10 14:20:36 poultd10 Exp $
|
   ...
   BEGIN
     ...
     IF p_msg_count > 0 THEN
         FOR i IN 1 .. p_msg_count
          LOOP
             p_err_msg := p_err_msg || ' ' ||fnd_msg_pub.get (p_msg_index => i, p_encoded => 'F');
          end loop;
     end if;
